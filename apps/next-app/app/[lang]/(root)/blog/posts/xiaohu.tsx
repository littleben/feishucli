...
export default function XiaohuArticle({ lang = "zh-CN" }: ArticleProps) {
  if (lang === "en") {
    return (
      <div className="space-y-6">
        <img src="/images/features/calendar-demo.png" alt="Task automation and calendar workflows in Lark" className="w-full rounded-xl border border-border" />

        <h2 className="text-xl font-semibold mt-8 mb-3">Using CLAUDE.md to turn AI into a task operator</h2>
        ...
        <h2 className="text-xl font-semibold mt-8 mb-3">Natural conversation can become structured execution</h2>
        <p className="text-muted-foreground leading-relaxed">
        ...
        <h2 className="text-xl font-semibold mt-8 mb-3">The bigger win is the closed loop</h2>
        <p className="text-muted-foreground leading-relaxed">
        ...
        <h2 className="text-xl font-semibold mt-8 mb-3">Markdown and the knowledge base can work as one system</h2>
        <p className="text-muted-foreground leading-relaxed">
        ...
        <h2 className="text-xl font-semibold mt-8 mb-3">Base workflows make invisible time and content work visible</h2>
        <h3 className="text-lg font-medium mt-4 mb-2">Time allocation tracking</h3>
        <p className="text-muted-foreground leading-relaxed">
        ...
        <h3 className="text-lg font-medium mt-4 mb-2">Content pipeline tracking</h3>
        <p className="text-muted-foreground leading-relaxed">
        ...
        <h2 className="text-xl font-semibold mt-8 mb-3">CLI removes the wall between AI and enterprise software</h2>
        <p className="text-muted-foreground leading-relaxed">
        ...
        <div className="mt-12 pt-8 border-t border-border">
          <p className="text-sm text-muted-foreground">
            Adapted from Xiaohu&apos;s original Chinese article.
            <a
