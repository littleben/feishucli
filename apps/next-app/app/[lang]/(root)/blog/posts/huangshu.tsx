...
export default function HuangshuArticle({ lang = "zh-CN" }: ArticleProps) {
  if (lang === "en") {
    return (
      <div className="space-y-6">
        <img src="/images/features/ai-doc-3.png" alt="AI reorganizing a Lark knowledge base" className="w-full rounded-xl border border-border" />

        <h2 className="text-xl font-semibold mt-8 mb-3">Using AI to rebuild a messy knowledge base</h2>
        ...
        <h2 className="text-xl font-semibold mt-8 mb-3">Comments turn AI into an editor instead of a generator</h2>
        <p className="text-muted-foreground leading-relaxed">
        ...
        <h2 className="text-xl font-semibold mt-8 mb-3">Markdown becomes easier to operationalize inside Lark</h2>
        <p className="text-muted-foreground leading-relaxed">
        ...
        <h2 className="text-xl font-semibold mt-8 mb-3">Turning meeting recordings into reusable documentation</h2>
        <p className="text-muted-foreground leading-relaxed">
        ...
        <h2 className="text-xl font-semibold mt-8 mb-3">Why the CLI feels effective in practice</h2>
        <h3 className="text-lg font-medium mt-4 mb-2">Broad coverage</h3>
        <p className="text-muted-foreground leading-relaxed">
        ...
        <h3 className="text-lg font-medium mt-4 mb-2">Low setup overhead</h3>
        <p className="text-muted-foreground leading-relaxed">
        ...
        <h3 className="text-lg font-medium mt-4 mb-2">Error messages that help the agent recover</h3>
        <p className="text-muted-foreground leading-relaxed">
        ...
        <h2 className="text-xl font-semibold mt-8 mb-3">Why open source changes the enterprise conversation</h2>
        <p className="text-muted-foreground leading-relaxed">
        ...
        <div className="mt-12 pt-8 border-t border-border">
          <p className="text-sm text-muted-foreground">
            Adapted from Huangshu&apos;s original Chinese article.
            <a
